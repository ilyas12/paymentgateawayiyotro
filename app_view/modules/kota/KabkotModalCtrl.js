app.controller('KabkotModalCtrl', function ($scope, $state, $modalInstance,API,PathApiService,param,ngNotify,AuthService,$modal) {

	var api_url = PathApiService.kabkot();
