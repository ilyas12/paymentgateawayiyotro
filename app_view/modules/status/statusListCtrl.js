app.controller('statusListCtrl', function($scope, $state, $location, $filter,API,PathApiService,$modal,AuthService) {
    ...
    $scope.loadData = function(page)
    {
        ...
        API.get(PathApiService.status()+"/load?"+where).then(function(result){
	...
	$scope.add_data = function () {
        ...
        var data = {"size":"lg","param":param,"template":"modules/status/statusFormView.html","ctrl":"statusModalCtrl"};
    ...
    $scope.delete_data = function(id){
        ...
        var data = {"size":"sm","template":"modules/confirm/delete_confirm.html","ctrl":"statusModalCtrl","param":param};
        open_modal(data,$modal);
    }
