app.controller('PaymentMethodModalCtrl', function ($scope, $state, $modalInstance,API,PathApiService,param,ngNotify,AuthService,$modal) {
	
	var api_url = PathApiService.payment_method();
	...
	$scope.modal_title = "Add New Payment Method";
	if(param.action == "edit") { 
		$scope.getdata(); 
	 	$scope.modal_title = "Edit Payment Method";
	}
