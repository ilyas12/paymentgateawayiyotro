                ...
                link: function (scope, el, attrs, ctrls) {
                    ...
                    shouldProcess = function () {
                        ...
                        for (var p in ngModel.$error) {
                            var checkedKey = !options.hasOwnProperty('keys') || !( Object.keys(options.keys)
                                    .filter(function (k) {
                    ...
                    setValidation = function (response, skipCache) {
                        ...
                        for (; i < l; i++) {
                            ...
                            if (!response[i].data.isValid) {
                                isValid = false;
                                ngModel.$message = response[i].data.message;
                                if (!useKeys)  break;
                            }
                    ...
                    handleChange = function (value) {
                        ...
                        request = $timeout(function () {
                            var calls = [],
                                ...
                                toValidate = {value: value, rules: options.keys},
                                httpOpts = {
                                    ///headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                                    method: options.ngRemoteMethod
                                };
