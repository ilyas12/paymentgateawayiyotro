...
class PaymentMethod extends AR_Controller {
...

	{
		...
		$data = $this->payment_method_model->find($id);
...

	{
		...
		$this->payment_method_model->update($id,$post_data);
...

	{
		...
		$id = $this->payment_method_model->add($post_data);
